...
# Allow override via env; default matches local dev convention mentioned by user
TEST_DATABASE_URL = os.getenv(
    "TEST_DATABASE_URL",
    "postgresql+psycopg2://postgres:postgres@localhost:5432/budgetbuddy_test",
)
...
def test_engine():
    ...
    try:
        ...
        pytest.skip(
            "Skipping DB tests: cannot connect to TEST_DATABASE_URL.",
            f"Set TEST_DATABASE_URL or start Postgres. Details: {exc}",
        )
